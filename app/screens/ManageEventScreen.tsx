...
const ManageEventScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {isSuperAdmin && (
        <TouchableOpacity
          onPress={() => router.replace("./SuperAdminScreen")}
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          style={[
            ...
            selectedCategory === "past" && styles.selectedButton,
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.categoryButton,
            selectedCategory === "present" && styles.selectedButton,
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.categoryButton,
            selectedCategory === "future" && styles.selectedButton,
          ]}
                ...
                <View style={styles.actions}>
                  {isFutureEvent && (
                    <>
                      <TouchableOpacity
                        onPress={() =>
                          router.push(`/screens/EditEventScreen?id=${item.id}`)
                        }
